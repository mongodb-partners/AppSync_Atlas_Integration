...
create documents for customer and risk . please refer the sample structure for [CounterParty](https://github.com/mongodb-partners/AppSync_Atlas_Integration/blob/main/code/counterparty.json) and [CounterPartyRisk](https://github.com/mongodb-partners/AppSync_Atlas_Integration/blob/main/code/counterpartyrisk.json) documents.
